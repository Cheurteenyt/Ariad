...
reverse multi-hop callers, alias-aware TypeScript type dependents, bounded
route/CLI call chains, and tracked top-level repository inventory with explicit
completeness metadata. Use exact profiles
