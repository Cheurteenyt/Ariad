...
npm install
npm run build
npm test                    # 368 tests (347 backend + 21 frontend)
...
- [V2 Roadmap](../docs/V2_ROADMAP.md) — Current state + roadmap (updated 0.11.0)
...
- [Changelog](CHANGELOG.md) — Version history (0.1.0 → 0.11.0)
- [License](../LICENSE) — MIT
