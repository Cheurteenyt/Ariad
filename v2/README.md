...
npm install
npm run build
npm test                    # 348 tests (345 backend + 3 frontend)
...
- [V2 Roadmap](../docs/V2_ROADMAP.md) — Current state + roadmap (updated 0.10.8)
...
- [Changelog](CHANGELOG.md) — Version history (0.1.0 → 0.10.8)
- [License](../LICENSE) — MIT
