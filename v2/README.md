...
literals, declaration-qualified semantic call sites and transitive named-type
impact, persistent direct-caller aggregation, optional identity-aware reverse
multi-hop callers, bounded route/CLI call chains, and tracked top-level
