...
| `lookup_source_text` | read | Bounded exact literals, declaration-qualified call sites and transitive type impact, identity-aware direct/multi-hop callers, call chains, and tracked inventory |
