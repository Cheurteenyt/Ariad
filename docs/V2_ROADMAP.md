...
| R78–R106 | 0.16.0–0.41.0 | — | — | — |
| **Total** | | **566+** | **513+** | **378** |

> **Note:** Rounds R78–R106 (versions 0.16.0–0.41.0) are documented in
...
> The V2 indexer now has 53 tests across 11 test files covering correctness,
> incremental safety, cross-file CALLS, stale flag semantics, and deletion
> cleanup.
